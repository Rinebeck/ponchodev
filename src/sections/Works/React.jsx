  ...
  content: (
    <>
      <Grid container spacing={3}>
        <Grid item md>
          <ProjectCard
            body="Interior design preview tool, with lots of variants and cool stuff! Has it's own app (not on any store per client request) and a web version."
        ...
        <Grid item md>
          <ProjectCard
            body="IP Infrignments reporting portal made with React, Redux Toolkit and a PHP API"
